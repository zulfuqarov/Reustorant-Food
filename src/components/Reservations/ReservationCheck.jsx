...
const ReservationCheck = ({ CheckReser, CheckReservation, ModfyReservation }) => {
    return (
        <div className={`fixed overflow-y-auto z-20 inset-0 bg-black bg-opacity-50 backdrop-blur-sm flex items-center justify-center h-0 w-0  ${CheckReser ? 'h-[100vh] w-[100%]' : ''}`}>
            <div className="w-full max-w-[1000px] h-full mx-4 md:mx-auto p-4 rounded-lg shadow-lg  overflow-auto">

                <div className='float-right'>
                    <button onClick={CheckReservation} className='text-[40px] text-red-500 hover:text-red-900 transition-all'><i className="fa-solid fa-xmark"></i></button>
                </div>
                ...
                <div className="bg-white p-6 rounded-lg shadow-lg">
                    ...
                    <button onClick={ModfyReservation} className="bg-[#ff8900] text-white py-2 px-4 rounded-lg text-xl font-semibold">
                        Confirm Reservation
                    </button>
                </div>
            </div>
